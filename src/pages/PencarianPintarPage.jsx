      ...
      if (data?.signedUrl) {
        ...
        if (Capacitor.isNativePlatform()) {
          try {
            ...
            // User cancelled or closed share dialog - this is normal behavior
            console.log('Share dialog closed:', shareError);
          }
          ...
          if (navigator.share) {
            ...
            // Fallback for desktop: Copy to clipboard silently
