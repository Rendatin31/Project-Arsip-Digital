export default function FileTypeIcon({ type, size = 40, className = '' }) {
  ...
  // Word Icon (doc or docx)
  if (type === 'doc' || type === 'docx') {
    return (
      <svg {...common} viewBox="0 -1.27 110.031 110.031">
  ...
  // Excel Icon (xls or xlsx)
  if (type === 'xls' || type === 'xlsx') {
    return (
      <svg {...common} viewBox="0 -1.27 110.037 110.037">
  ...
  // Image Icon (keep simple)
  if (type === 'img') {
    return (
      <svg {...common} viewBox="0 0 48 48">
        <rect x="8" y="4" width="32" height="40" rx="5" fill="#2B7CD3" />
        <rect x="8" y="4" width="32" height="40" rx="5" fill="#ffffff" opacity="0.06" />
        <g>
          <circle cx="18" cy="15" r="3" fill="#ffffff" />
          <path d="M11 37 L21 25 L27 31 L32 26 L38 37 Z" fill="#ffffff" />
        </g>
      </svg>
    );
  }
  ...
  return (
    <svg {...common} viewBox="0 0 48 48">
      <rect x="8" y="4" width="32" height="40" rx="5" fill="#76777D" />
      <rect x="8" y="4" width="32" height="40" rx="5" fill="#ffffff" opacity="0.06" />
      <text
        x="24"
        y="30"
