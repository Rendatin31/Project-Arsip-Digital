      ...
      <main className="bg-white w-full max-w-md h-auto flex overflow-hidden shadow-2xl rounded-2xl">
        ...
        <section className="flex-1 p-8 md:p-14 flex flex-col justify-center bg-white">
          <div className="w-full max-w-md mx-auto">
            ...
            {/* Header */}
            <div className="mb-2">
              <h2 className="text-[16px] !text-[16px] md:text-sm font-bold md:font-medium text-gray-800 mb-2">Sign in</h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative">
                ...
                />
                <button
                  className="absolute inset-y-0 right-0 pr-3 flex items-center text-[13px] !text-[13px] font-bold text-gray-600 hover:text-blue-600"
                  type="button"
