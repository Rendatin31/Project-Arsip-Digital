      ...
      <div className="flex items-center gap-lg lg:ml-auto">
        <div className="flex items-center gap-4 lg:gap-sm">
          ...
          <div className="relative" ref={notifRef}>
            ...
            >
              <span className={`material-symbols-outlined transition-colors !text-[48px] md:!text-[24px] ${showNotifications ? 'text-primary' : 'text-on-surface-variant'}`}>
                notifications
              </span>
              {unreadCount > 0 && (
                <>
          ...
          <div className="lg:hidden relative" ref={platformMenuRef}>
            ...
            >
              <span className={`material-symbols-outlined transition-colors !text-[48px] md:!text-[24px] ${showPlatformMenu ? 'text-primary' : 'text-on-surface-variant'}`}>
                download
              </span>
            </button>
          ...
          >
            <span className="material-symbols-outlined text-on-surface-variant group-hover:text-primary transition-colors !text-[48px] md:!text-[24px]">
              settings
            </span>
          </button>
