                            ...
                            <div className="relative flex-shrink-0">
                              ...
                              >
                                {isSystemNotification ? (
                                  ...
                                  >
                                    <span 
                                      className="material-symbols-outlined filled-icon text-gray-500 !text-[48px] md:!text-[40px]"
                                      style={{ 
                                        lineHeight: '1',
                                        display: 'block',
                                        textAlign: 'center'
          ...
          <div className="relative hidden lg:flex">
            ...
            >
              ...
              <div className={`w-8 lg:w-8 h-8 lg:h-8 rounded-full bg-gray-100 flex items-center justify-center avatar-fallback relative left-[4px] lg:left-0 ${profile?.avatar_url ? 'hidden' : ''}`} style={{ border: '2px solid #e5e7eb' }}>
                <span className="material-symbols-outlined filled-icon text-gray-500 text-[32px] lg:!text-[28px]" style={{ lineHeight: '1' }}>
                  account_circle
                </span>
              </div>
