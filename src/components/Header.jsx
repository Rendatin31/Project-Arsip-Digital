            ...
            >
              ...
              {unreadCount > 0 && (
                <>
                  ...
                  <span className="absolute top-[2px] right-[2px] md:top-1 md:right-1 bg-error text-white text-[11px] lg:text-[10px] font-bold rounded-full w-4 h-4 lg:w-4 lg:h-4 flex items-center justify-center">
