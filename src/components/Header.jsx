  ...
  return (
    <header className="flex justify-between items-center pr-1 pl-lg lg:px-lg w-full sticky top-0 z-40 bg-surface-container-lowest border-b border-outline-variant shadow-sm h-16">
      ...
      <div className="flex items-center gap-lg lg:ml-auto">
        <div className="flex items-center gap-3 lg:gap-sm">
          ...
          <div className="relative" ref={notifRef}>
            ...
            >
              <span className={`material-symbols-outlined transition-colors !text-[46px] md:!text-[24px] ${showNotifications ? 'text-primary' : 'text-on-surface-variant'}`}>
                notifications
              </span>
              {unreadCount > 0 && (
                <>
          ...
          <div className="lg:hidden relative" ref={platformMenuRef}>
            ...
            >
              <span className={`material-symbols-outlined transition-colors !text-[46px] md:!text-[24px] ${showPlatformMenu ? 'text-primary' : 'text-on-surface-variant'}`}>
                download
              </span>
            </button>
          ...
          >
            <span className="material-symbols-outlined text-on-surface-variant group-hover:text-primary transition-colors !text-[46px] md:!text-[24px]">
              settings
            </span>
          </button>
